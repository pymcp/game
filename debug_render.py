...
if cave_col is None:
    ...
    if current_map_for_player:
        print(f"  Map size: {current_map_for_player.cols}x{current_map_for_player.rows}")
    ...
    if start_col >= end_col or start_row >= end_row:
        ...
        if start_col <= tile_at_player_col < end_col and start_row <= tile_at_player_row < end_row:
            tile_at_player = current_map_for_player.get_tile(tile_at_player_row, tile_at_player_col)
